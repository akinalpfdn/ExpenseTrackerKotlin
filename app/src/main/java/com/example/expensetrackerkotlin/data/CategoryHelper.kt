...
object CategoryHelper {
    ...
    val subCategories = listOf(
        ...
        ExpenseSubCategory("Fast food", ExpenseCategory.FOOD),
        ExpenseSubCategory("Evde yemek (malzeme)", ExpenseCategory.FOOD),
        ExpenseSubCategory("Su ve içecek", ExpenseCategory.FOOD),
        ...
        ExpenseSubCategory("Giyim ve aksesuar", ExpenseCategory.HEALTH),
        ExpenseSubCategory("Parfüm", ExpenseCategory.HEALTH),
        ...
        ExpenseSubCategory("Kitaplar", ExpenseCategory.EDUCATION),
        ...
        ExpenseSubCategory("Giysi", ExpenseCategory.SHOPPING),
        ExpenseSubCategory("Ayakkabı", ExpenseCategory.SHOPPING),
    ...
    private val categoryMapping = mapOf(
        ...
        "Fast food" to ExpenseCategory.FOOD,
        "Evde yemek (malzeme)" to ExpenseCategory.FOOD,
        "Su ve içecek" to ExpenseCategory.FOOD,
        ...
        "Parfüm" to ExpenseCategory.HEALTH,
        ...
        "Kitaplar" to ExpenseCategory.EDUCATION,
        ...
        "Giysi" to ExpenseCategory.SHOPPING,
        "Ayakkabı" to ExpenseCategory.SHOPPING,
